...
namespace cds_static
{
    ...
    class wt_node_internal: public wt_node
    {
        public:
            ...
            virtual size_t rank_prefix(uint *symbol, size_t pos, uint level, wt_coder *c, uint deep) const;
            ...
            virtual size_t select_prefix(uint *symbol, size_t pos, uint level, wt_coder *c, uint deep) const;
